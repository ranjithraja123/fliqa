...
//update product by id as params
...
exports.getAdminProducts = catchAsyncError(async (req, res, next) => {
  ...
  exports.uploadProductImages = catchAsyncError(async (req, res) => {
    let product = await Product.findById(req?.params?.id);
  ...
  exports.deleteProductImage = catchAsyncError(async (req, res) => {
    let product = await Product.findById(req?.params?.id);
  ...
  exports.canUserReview = catchAsyncError(async (req, res) => {
