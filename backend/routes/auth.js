...
const {registerUser,loginUser, logout,forgotPassword,resetPassword,getUserProfile,uploadAvatar,updatePassword,updateProfile,allUsers,getUserDetails,deleteUser,updateUser} = require('../controllers/authController');
